...
const Home = () => {
  ...
  return (
    <div className='flex justify-center w-full h-screen'>
        <div className={`bg-[${Colors.dark}] mt-10 bg-opacity-50 backdrop-blur-xl backdrop-filter backdrop-saturate-200 p-5 md:p-10 shadow-xl rounded-lg h-[80vh] md:h-[60vh] max-w-[1000px] w-[92vw] md:w-[50vw] flex flex-col justify-center items-center`}>
            <div>
