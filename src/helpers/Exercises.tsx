export const Exercises = {
    ...
    "Bulgarian Split Squat": {
      ...
      "instructions": [
        "To perform a Bulgarian Split Squat, you'll need a bench or a sturdy elevated surface and a pair of dumbbells. Begin by standing a few feet in front of the bench with your back to it.",
        "Hold a dumbbell in each hand by your sides. Extend one leg behind you and place the top of your foot on the bench or elevated surface. This will be your starting position.",
        "Maintaining an upright torso and keeping your chest up, lower your back knee toward the ground, bending both knees to form a 90-degree angle with your front thigh parallel to the floor. Your front knee should not extend beyond your toes.",
        ...
        "Make sure to engage your core muscles for stability and keep your balance as you perform the exercise."
      ],
      "category": "strength"
    },    
    "Butt-Ups": {
    ...
    "Chest Supported Row": {
      ...
      "instructions": [
        "To perform a Chest Supported Row, you'll need a bench or a chest-supported row machine. Begin by positioning yourself face down on the bench with your feet flat on the floor and your knees slightly bent.",
        "Grasp a dumbbell in each hand, palms facing inwards, and let your arms hang straight down toward the floor. Your chest should be firmly pressed against the pad of the bench, and your back should be flat.",
        "Initiate the exercise by retracting your shoulder blades. In a controlled motion, pull the dumbbells toward your lower ribcage while keeping your elbows close to your body.",
        "At the top of the movement, squeeze your back muscles for a brief pause, feeling the contraction.",
        "Slowly lower the dumbbells back to the starting position, fully extending your arms.",
        "Repeat this movement for the desired number of repetitions, focusing on maintaining proper posture and engaging your core muscles to support your lower back throughout the exercise."
      ],
      "category": "strength"
    },    
    "Child's Pose": {
